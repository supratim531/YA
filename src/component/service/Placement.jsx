  ...
  return (
    <div className="py-10 flex flex-col gap-y-20 mx-auto container">
      ...
      <div className="lg:mx-10 flex flex-wrap justify-center gap-10">
        <div className="px-4 py-10 flex gap-x-8 justify-between items-center rounded-sm cursor-pointer hover:-translate-y-4 duration-100 border-r-4 border-[#f6f7f7] hover:border-primary hover:shadow-[0px_0px_12px_4px_rgba(0,0,0,0.3)] hover:shadow-slate-300 bg-[#f6f7f7]">
