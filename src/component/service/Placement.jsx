      ...
      <div className="lg:mx-10 flex flex-wrap justify-center gap-10">
        {
          courses.map(e => {
            return (
              <div className="px-6 w-[360px] h-[130px] flex justify-between rounded-sm cursor-pointer hover:-translate-y-4 duration-100 border-r-4 border-[#f6f7f7] hover:border-primary hover:shadow-[0px_0px_12px_4px_rgba(0,0,0,0.3)] hover:shadow-slate-300 bg-[#f6f7f7]">
