        ...
        <div className="lg:mx-10 flex flex-col lg:flex-row justify-between gap-y-5 lg:gap-y-4">
          <div className="font-[Poppins] w-full flex flex-col justify-center">
            <div className="space-y-1.5">
              ...
              <div className="text-3xl lg:text-4xl font-bold text-secondary-dark">
                Create A New Way To
              </div>
              ...
              <div className="pt-2 text-slate-400">
                <span>
                  Stay organised and improve. Streamline sales, marketing,
                  customer service, and other business operations of your
